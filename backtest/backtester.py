...
class Backtester:
    ...
    def run(self, df: pd.DataFrame, strategy_name: str = "Unknown",
        ...
        for i, (idx, row) in enumerate(df.iterrows()):
            ...
            if plain_short_for_bar and signal == -1 and position == 0 and cash > 0 and not regime_blocked and not risk_entry_blocked and not self._cb_active and (atr_series is None or self._stamp_entry_atr(atr_series, idx, fill_price) > 0):
